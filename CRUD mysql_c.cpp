...
void ingresar(int opcion, MYSQL* conectar) {
    ...
    if (opcion == 2) {
        ...
        switch (a) {
        case 1:
            insert = "INSERT INTO productos (producto,idMarca,descripcion,precio_costo,precio_venta,existencia,fecha_ingreso) values('" + producto + "'," + idmarca + ",'" + descripcion + "','" + precio_costo + "','" + precio_venta + "','" + existencia + "',now())";
            break;
        case 2:
            cout << "DIA: ";
            cin >> dia;
            ...
            cout << "SEGUNDOS: ";
            cin >> segundos;
            insert = "INSERT INTO productos (producto,idMarca,descripcion,precio_costo,precio_venta,existencia,fecha_ingreso) values('" + producto + "'," + idmarca + ",'" + descripcion + "','" + precio_costo + "','" + precio_venta + "','" + existencia + "','" + anio + "-" + mes + "-" + dia + " " + hora+":"+minutos+":"+segundos+"')";
            break;
        default:
    ...
    if (opcion == 2) {
        ...
        if (!q_estado) {
            ...
            if ((respuesta == 's') || (respuesta == 'S')) {
                ...
                switch (a) {
                case 1:
                    modificar = "UPDATE productos SET producto = '"+producto+"', idMarca = '"+idmarca+"', descripcion = '"+descripcion+"', precio_costo = '"+precio_costo+"', precio_venta = '"+precio_venta+"', existencia = '"+existencia+"', fecha_ingreso = now() WHERE (idProducto = '"+id+"');";
                    break;
                case 2:
                    cout << "DIA: ";
                    cin >> dia;
                    ...
                    cout << "SEGUNDOS: ";
                    cin >> segundos;
                    modificar = "UPDATE productos SET producto = '" + producto + "', idMarca = '" + idmarca + "', descripcion = '" + descripcion + "', precio_costo = '" + precio_costo + "', precio_venta = '" + precio_venta + "', existencia = '" + existencia + "', fecha_ingreso ='" + anio + "-" + mes + "-" + dia + " " + hora + ":" + minutos + ":" + segundos + "' WHERE (idProducto = '" + id + "');";
                    break;
                default:
                    cout << "OPCION NO VALIDA, SE INGRESARA FECHA Y HORA ACTUALES ";
                    modificar = "UPDATE productos SET producto = '" + producto + "', idMarca = '" + idmarca + "', descripcion = '" + descripcion + "', precio_costo = '" + precio_costo + "', precio_venta = '" + precio_venta + "', existencia = '" + existencia + "', fecha_ingreso = now() WHERE (idProducto = '" + id + "');";
